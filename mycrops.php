...
$result = file_get_contents("http://farmersmarket.com/api/v1/crop.php?user_id=".$_GET['user_id']);
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">My Crops</h5>
							...
							<table class="table datatable-basic">
								...
								<tbody>
									...
									<?php 
										...
										<td><a href="updatecrops.php?crop_id=<?php echo $value['crop_id']; ?>" class="btn btn-primary btn-block">UPDATE</a></td>
										<td><a href="/include/deletecrops.aut.php?crop_id=<?php echo $value['crop_id']; ?>" 
											onclick="return confirm('Are you sure? you and to delete crop <?php echo $value['crop_id']; ?>')" class="btn btn-danger btn-block">DELETE</a></td>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header bg-danger">
														...
														<h6 class="modal-title">Delete Crop</h6>
													</div>

													<div class="modal-body">
														<div class="alert alert-danger alert-styled-left text-blue-800 content-group">
											                <span class="text-semibold">Are you sure you want to delete this crop</span> 
											            </div>

													</div>

													<div class="modal-footer">
														<a href="/include/deletecrops.aut.php?crop_id=<?php echo $value['crop_id']; ?>" class="btn btn-danger btn-block">DELETE</a></td>
													</div>
												</div>
											</div>
										</div>----->
