...
<head>
	...
	<title>Farmers Market - Update Crops</title>
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								if(isset($_SESSION['email'])){
									...
									if ($_SESSION['type'] == 1) {
										...
										<li><a href="explore.php"><i class="icon-eye"></i> <span>Explore</span></a></li>
										<li class="active"><a href=mycrops.php?user_id=' . $eid . '"><i class="icon-circle"></i> <span>My Crops</span></a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Update Crops</h4>
						</div>
					</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Update Crops</li>
						</ul>
					</div>
				</div>
				<!-- /page header -->
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-add position-left"></i>UPDATE CROPS</h5>
						...
						<div class="panel-body">
							...
							<div class="col-lg-6">
							<form class="form-horizontal" action="/include/updatecrop.aut.php" method="POST">
								<fieldset class="content-group">
									...
									<input type="hidden" class="form-control" placeholder="" id="crop_id" name="crop_id" value="<?php echo $crop['crop_id'];?>" >
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" placeholder="Enter your crops name" id="crop_name" name="crop_name" value="<?php echo $crop['crop_name'];?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="number" class="form-control" placeholder="Enter your crops price" id="crop_price" name="crop_price" value="<?php echo $crop['crop_price'];?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" placeholder="Enter your crops location" id="crop_location" name="crop_location" value="<?php echo $crop['crop_location'];?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
					<textarea rows="5" cols="5" class="form-control" placeholder="Type crop description here" id="crop_description" name="crop_description" ><?php echo $crop['crop_description'];?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" placeholder="Type crop longitude here" id="longitude" name="longitude" value="<?php echo $crop['longitude'];?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input class="form-control" type="text" placeholder="Type crop description here" id="latitude" name="latitude" value="<?php echo $crop['latitude'];?>">
										</div>
									</div>
									...
									<!---<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="file" class="file-styled-primary btn bg-blue">
										</div>
									</div>---->
								...
								<div class="text-right">
									<button type="submit" name="submit" class="btn bg-orange-400">UPDATE CROP <i class="icon-arrow-right14 position-right"></i></button>
								</div>
